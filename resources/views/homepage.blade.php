                ...
                <div class="row gx-5 align-items-center">
                    <div class="col-xxl-5">
                        ...
                        <div class="text-center text-xxl-start">
                            ...
                            <div class="fs-3 fw-light ">Il Tuo Futuro Digitale! </div>
                            <h2 class="display-3 fw-bolder mb-5"><span class="text-gradient d-inline">Sviluppo Web
                                    Creativo per la tua attività</span></h2>
                            <div
                                class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xxl-start mb-3">
                                <a class="btn btn-outline-primary"href="{{ route('serviziofferti') }}">Project</a>
                        ...
                        <div class="d-flex justify-content-center mt-5 mt-xxl-0">
                            <div class="profile bg-gradient-primary-to-secondary">
                                <img class="profile-img"
                                    src="\immagini\vadim-bogulov-krgb_3HIkME-unsplash-removebg-preview.png"
                                    alt="img-profile" />
                                <div class="dots-1">
                                    <!-- SVG Dots-->
                ...
                <div class="row gx-5 justify-content-center">
                    <div class="col-xxl-8">
                        <div class="text-center my-5">
                            ...
                            <p class="lead fw-light mb-4">Mi chiamo Pincopallino Bluetto e aiuto i brand a crescere
                            </p>
